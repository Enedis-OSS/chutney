...
import fr.enedis.chutney.kotlin.junit.engine.ChutneyTestEngine.Companion.CHUTNEY_JUNIT_ENGINE_ID
...
class ChutneyTestEngineTest {
    ...
    companion object {
        ...
        fun emptySelectors(): Array<Any> {
            return arrayOf(
                ...
                selectClasspathRoots(setOf(Path.of("./src/test/kotlin/fr/enedis/chutney/kotlin/junit/engine")))[0],
                selectClasspathResource("unknownResource"),
                selectMethod("fr.enedis.chutney.kotlin.junit.engine.ChutneyTest#unknownMethod()")
            )
        }
        ...
        fun containerChutneyTestSelectors(): Array<Any> {
            return arrayOf(
                arrayOf(selectClass("fr.enedis.chutney.kotlin.junit.engine.ChutneyTest"), 46, 46, 75),
                arrayOf(selectClasspathRoots(setOf(Path.of(".")))[0], 49, 49, 77),
                arrayOf(
                    selectClasspathResource("fr/enedis/chutney/kotlin/junit/engine/ChutneyTest.class"), 46, 46, 75
                ),
                arrayOf(selectMethod("fr.enedis.chutney.kotlin.junit.engine.ChutneyTest#withSubSteps()"), 12, 12, 10)
            )
        }
    }
    ...
    fun should_get_groupId() {
        assertThat(sut.groupId).hasValue("fr.enedis.chutney")
    }
