...
package fr.enedis.chutney.kotlin.dsl
 ...
 * -------
 * Outputs:
 * - results : list of result of commands (List<fr.enedis.chutney.action.ssh.sshj.CommandResult>)
 */
 ...
 * -------
 * Outputs:
 * - sshServer : instance of ssh server (fr.enedis.chutney.action.ssh.sshd.SshServerMock)
 * -------
 ...
 * -------
 * Outputs:
 * - recordResult : list of result of sql command (List<fr.enedis.chutney.action.sql.core.Records>)
 */
...
/**
 * Selenium wait until fr.enedis.chutney.action.selenium.SeleniumWaitAction.ExpectedByConditionEnum
 */
...
/**
 * Same as fr.enedis.chutney.kotlin.dsl.ChutneyStepImplExtensionsKt.JsonAssertAction(String, Map<String,Object>)
