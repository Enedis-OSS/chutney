...
package fr.enedis.chutney.idea.insert

import fr.enedis.chutney.idea.completion.field.model.StringField
import fr.enedis.chutney.idea.completion.value.StepValueData
import fr.enedis.chutney.idea.completion.value.model.StepValue
...
class JsonStepInsertValueHandler(private val value: Value) : InsertHandler<LookupElement> {
    ...
    private fun getIndentation(context: InsertionContext, item: LookupElement): Int {
        ...
        return fr.enedis.chutney.idea.util.StringUtils.getNumberOfSpacesInRowStartingFromEnd(
