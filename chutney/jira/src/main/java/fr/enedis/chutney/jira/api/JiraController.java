...
public class JiraController {
    ...
    @PreAuthorize("hasAnyAuthority('SCENARIO_READ', 'CAMPAIGN_WRITE', 'EXECUTION_READ')")
    ...
    @PreAuthorize("hasAnyAuthority('SCENARIO_WRITE', 'CAMPAIGN_WRITE')")
    ...
    @PreAuthorize("hasAnyAuthority('CAMPAIGN_WRITE', 'EXECUTION_READ')")
