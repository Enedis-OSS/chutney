...
public class XmlContentTest {
    ...
    public void xpath_works_whereas_default_namespace() {
        fr.enedis.chutney.action.jms.domain.XmlContent xmlContent = new fr.enedis.chutney.action.jms.domain.XmlContent(XmlUtils.saxBuilder(), loadFileFromClasspath("xml_samples/with_default_and_tag_namespaces.xml"));
    ...
    public void buildDocument_of_unparsable_xl_returns_empty() {
        fr.enedis.chutney.action.jms.domain.XmlContent xmlContent = new XmlContent(XmlUtils.saxBuilder(), "<test");
