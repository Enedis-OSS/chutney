...
public class ScenarioIndexingAspect {
    private final ScenarioIndexRepository reportIndexRepository;

    public ScenarioIndexingAspect(ScenarioIndexRepository reportIndexRepository) {
    ...
    public void index(GwtTestCase testCase, String id) {
        ...
        reportIndexRepository.save(ScenarioEntity.fromGwtTestCase(testCaseWithId));
    }
    ...
    public void delete(String scenarioId) {
        reportIndexRepository.delete(Long.valueOf(scenarioId));
