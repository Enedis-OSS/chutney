...
!!! info "[Browse Implementation](https://github.com/Enedis-OSS/chutney/blob/main/chutney/action-impl/src/main/java/fr/enedis/chutney/action/micrometer/MicrometerGaugeAction.java){:target="_blank"}"
...
=== "Inputs"
    ...
    !!! info
        ...
        7. GaugeFunction should return an `int`, `long`, `float`, `double` or any [Number](https://devdocs.io/openjdk~21/java.base/java/lang/number){:target=_blank}'s child class.
...
!!! info "[Browse Implementation](https://github.com/Enedis-OSS/chutney/blob/main/chutney/action-impl/src/main/java/fr/enedis/chutney/action/micrometer/MicrometerTimerAction.java){:target="_blank"}"
...
=== "Inputs"
    ...
    |                    | `expiry`                      | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                              | Distribution statistic expiry                                                                                                                |
    |                    | `maxValue`                    | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                              | Timer max duration                                                                                                                           |
    |                    | `minValue`                    | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                              | Timer min duration                                                                                                                           |
    ...
    |                    | `registry`                    | [MeterRegistry](https://javadoc.io/doc/io.micrometer/micrometer-core/latest/io/micrometer/core/instrument/MeterRegistry.html){:target=_blank} | Creates and manages your application's set of meters                                                                                         |
    |                    | `timeunit`                    | [TimeUnit](https://devdocs.io/openjdk~21/java.base/java/util/concurrent/timeunit){:target=_blank}  as String        | Time unit                                                                                                                                    |
    |                    | `record`                      | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                              | The timer will be updated by the record duration                                                                                             |
...
!!! info "[Browse Implementation](https://github.com/Enedis-OSS/chutney/blob/main/chutney/action-impl/src/main/java/fr/enedis/chutney/action/micrometer/MicrometerTimerStartAction.java){:target="_blank"}"
...
!!! info "[Browse Implementation](https://github.com/Enedis-OSS/chutney/blob/main/chutney/action-impl/src/main/java/fr/enedis/chutney/action/micrometer/MicrometerTimerStopAction.java){:target="_blank"}"
...
=== "Inputs"
    ...
    |          | `timeunit` | [TimeUnit](https://devdocs.io/openjdk~21/java.base/java/util/concurrent/timeunit){:target=_blank}  as String           | Time unit. Default is SECONDS                      |

=== "Outputs"

    | Name                            | Type                                                                                                              | Description                  |
    |:--------------------------------|:------------------------------------------------------------------------------------------------------------------|:-----------------------------|
    | `micrometerTimerSampleDuration` | [Duration](https://devdocs.io/openjdk~21/java.base/java/time/duration){:target=_blank}  | The sample recorded duration |
...
!!! info "[Browse Implementation](https://github.com/Enedis-OSS/chutney/blob/main/chutney/action-impl/src/main/java/fr/enedis/chutney/action/micrometer/MicrometerSummaryAction.java){:target="_blank"}"
...
=== "Inputs"
    ...
    |                                  | `bufferLength`                | Integer as String                                                                                                                                                                      | Distribution statistic buffer length                                                                                                         |
    |                                  | `expiry`                      | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                                                                       | Distribution statistic expiry                                                                                                                |
    |                                  | `maxValue`                    | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                                                                       | Distrubution max duration                                                                                                                    |
    |                                  | `minValue`                    | [Duration](https://enedis-oss.github.io/chutney/documentation/actions/introduction.md/#duration-type)                                                                                       | Distrubution min duration                                                                                                                    |
    |                                  | `percentilePrecision`         | Integer as String                                                                                                                                                                      | Percentile precision                                                                                                                         |
    |                                  | `publishPercentilesHistogram` | Boolean                                                                                                                                                                                | Publish percentile histogram or not                                                                                                          |
    |                                  | `percentiles`                 | String                                                                                                                                                                                 | Comma separated list of doublepercentiles doubles                                                                                            |
    |                                  | `sla`                         | String                                                                                                                                                                                 | Comma separated list of doublepercentiles doubles                                                                                            |
